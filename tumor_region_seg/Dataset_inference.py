...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, args, slide, xy_coord, slide_patch_ratio, transform=None, mean=0.5, std=0.5, input_type='RGB'):
        ...
        self.size_on_slide = int(self.patch_size*self.s_p_ratio)

        # self.data_dir = '/mnt/ssd1/biomarker/c-met/final_output'
    ...
    def __getitem__(self, index):
        ...
        # input.convert('RGB').save(os.path.join(self.data_dir, f'S-LC0027-MET_{coord[0]}_{coord[1]}_input.jpg'))
